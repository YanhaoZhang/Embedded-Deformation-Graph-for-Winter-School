...
%
%   [vertex,face,color] = read_ply(filename);
%
%   'vertex' is a 'nb.vert x 3' array specifying the position of the vertices.
%   'face' is a 'nb.face x 3' array specifying the connectivity of the mesh.
%   'color' is a 'nb.color x 3' array specifying the color of the vertices.
%
%
%   Copyright (c) 2003 Gabriel Peyr?
%   Ugly addition of the color loading by R. Falque
...
% highly inefficient as it read the file twice
temp = pcread(filename);
color = temp.Color;
