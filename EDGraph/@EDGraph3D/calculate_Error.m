...
pts_after = obj.control_pts_after;
for i=1:obj.num_control_pts_prior
    ...
    % calculate error
    tem_diff = (pts_mapped - pts_after(:,i));  
    
    observation_ii = observation_ii + 1;
    obj.Error_whole(position_x+dim_obs*(observation_ii-1)+1:position_x+dim_obs*observation_ii,1) = sigma_obs * tem_diff;  
end
